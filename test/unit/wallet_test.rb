...
class WalletTest < ActiveSupport::TestCase
  ...
  test "channel_balances have correct BAT and probi amounts" do
    ...
    test_wallet.channel_balances.each do |channel_identifier, channel_balance|
      assert_equal (channel_balance.amount_probi.to_i + channel_balance.fees_probi.to_i).to_s, "58217204799751874334"
      assert_equal channel_balance.amount_bat, "55.31" # 55.306344559764280618
      assert_equal channel_balance.fees_bat, "2.91" #2.910860239987593716
    end
  end
  ...
  test "referral_balance has correct BAT and probi amounts" do
    ...
    assert_equal referral_balance.amount_bat, "58.217204799751874334"
  ...
  test "overall balance has correct BAT and probi amounts" do
    total_balance_probi = accounts.count.times.sum { 58217204799751874334 }.to_s
    total_fees_probi = accounts.select {|account| account["account_type"] == Eyeshade::BaseBalance::CHANNEL}.count.times.sum { 2910860239987593716 }.to_s
    overall_balance = test_wallet.overall_balance
    assert_equal (overall_balance.amount_probi.to_i + overall_balance.fees_probi.to_i).to_s, total_balance_probi
  ...
  test "last settlement balance has correct timestamp and amount" do
    ...
    assert_equal last_settlement_balance.amount_bat, "151.24"
    assert_equal last_settlement_balance.amount_settlement_currency, "0.12"
  end
